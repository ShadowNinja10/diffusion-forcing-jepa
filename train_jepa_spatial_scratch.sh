#!/bin/bash -e
#SBATCH --job-name=jepa-spatial-scratch-training
#SBATCH --gres=gpu:2
#SBATCH --nodes=1
...
#SBATCH --mem=60G
#SBATCH -t 12:00:00
#SBATCH --output=logs/jepa-spatial-scratch-training_%j.out
#SBATCH --error=logs/jepa-spatial-scratch-training_%j.err
