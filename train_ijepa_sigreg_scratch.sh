#!/bin/bash -e
#SBATCH --job-name=ijepa-sigreg-scratch
#SBATCH --gres=gpu:4
#SBATCH --nodes=1
...
#SBATCH --mem=60G
#SBATCH -t 16:00:00
#SBATCH --output=logs/ijepa-sigreg-scratch_%j.out
#SBATCH --error=logs/ijepa-sigreg-scratch_%j.err
